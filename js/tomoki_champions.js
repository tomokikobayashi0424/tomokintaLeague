...
document.addEventListener("DOMContentLoaded", () => {
    const phases = ["初戦", "準々決勝", "準決勝", "決勝"];
    const matchDataChampions = {};
    let currentPhaseIndex = 0;

    const seedTeams = ["第1シード", "第2シード", "第3シード", "第4シード"];
    const matchesPerPhase = [4, 4, 2, 2];

    function initializeMatchData() {
        matchDataChampions["round0-match0"] = { home: { teamId: null }, away: { teamId: null }, date: "2024-12-30" };
        matchDataChampions["round0-match1"] = { home: { teamId: null }, away: { teamId: null }, date: "2024-12-30" };
        matchDataChampions["round0-match2"] = { home: { teamId: null }, away: { teamId: null }, date: "2024-12-30" };
        matchDataChampions["round0-match3"] = { home: { teamId: null }, away: { teamId: null }, date: "2024-12-30" };
        matchDataChampions["round1-match0"] = { home: { teamId: null }, away: { teamId: null }, date: "2024-12-30" };
        matchDataChampions["round1-match1"] = { home: { teamId: null }, away: { teamId: null }, date: "2024-12-30" };
        matchDataChampions["round1-match2"] = { home: { teamId: null }, away: { teamId: null }, date: "2024-12-30" };
        matchDataChampions["round1-match3"] = { home: { teamId: null }, away: { teamId: null }, date: "2024-12-30" };
    }

    function getTeamsForPhase(phase) {
        if (phase === "初戦") {
            return [
                "第1シード",
                "初戦 第1試合 ホームチーム",
            ...
            return [
                `第1シード (ID: ${matchDataChampions["round1-match0"].home.teamId || "未定"})`,
                `初戦 第1試合 勝利チーム (ID: ${matchDataChampions["round0-match0"].home.teamId || "未定"})`,
                `初戦 第2試合 勝利チーム (ID: ${matchDataChampions["round0-match1"].home.teamId || "未定"})`,
                `第2シード (ID: ${matchDataChampions["round1-match1"].away.teamId || "未定"})`,
                `第3シード (ID: ${matchDataChampions["round1-match2"].home.teamId || "未定"})`,
                `初戦 第3試合 勝利チーム (ID: ${matchDataChampions["round0-match2"].home.teamId || "未定"})`,
                `初戦 第4試合 勝利チーム (ID: ${matchDataChampions["round0-match3"].home.teamId || "未定"})`,
                `第4シード (ID: ${matchDataChampions["round1-match3"].away.teamId || "未定"})`
            ];
        }
        return [];
    }
